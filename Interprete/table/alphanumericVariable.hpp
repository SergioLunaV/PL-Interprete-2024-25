...
*/
    private:
        std::string     _value;     //!< \brief String value of the AlphanumericVariable
...
/*!		
	...
	\param value: string value of the AlphanumericVariable
	\pre   None
...
/*!		
	...
	\sa    setName, setValue
*/
	inline AlphanumericVariable(const AlphanumericVariable & n)
	{
		// Inherited methods
...
/*!	
	\brief   This function modifies the value of the AlphanumericVariable
	\note    Inline function
